...
export class ReportesComponent implements OnInit {
  ...
  if (this.visualizar == "N")
  {
    ...
    this.sentenciaR = "SELECT 'Reporte de efectividad por operacion', '', '', '', '' UNION SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "dd-MMM-yyyy HH:mm:ss") + "', '', '', '', '' UNION SELECT 'Rango: " + this.periodo + "', '', '', '', '' UNION SELECT 'Operacion', 'Total lotes', 'Lotes OK', 'Lotes con demora', '% OK' UNION SELECT a.nombre, IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso = a.id " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IF((SELECT total) > 0, ROUND((SELECT buenos) / (SELECT total) * 100, 0), 0) AS pct FROM sigma.cat_procesos a " + cadWhereExt + " " + cadHaving + " UNION SELECT '(TOTAL PLANTA)', IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso > 0 " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IF((SELECT total) > 0, ROUND((SELECT buenos) / (SELECT total) * 100, 0), 0) AS pct FROM sigma.cat_procesos a " + cadWhereExt + " ";      
    if (vista == 2)
    {
      this.tituloReporte ="Tiempo ocupado por operación " + this.periodo
      sentencia = "SELECT * FROM (SELECT 1 as pos, a.nombre, IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso = a.id  " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IFNULL((SELECT SUM(c.tiempo_estimado - b.tiempo_stock) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso = a.id " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo_proceso) FROM sigma.lotes_historia WHERE proceso = a.id " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct, CONCAT((SELECT pct), '%') AS pctchar FROM sigma.cat_procesos a " + cadWhereExt + " " + cadHaving + ") as query01 UNION (SELECT 0, 'TOTAL GENERAL', IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso > 0 " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IFNULL((SELECT SUM(c.tiempo_estimado - b.tiempo_stock) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso > 0 " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo_proceso) FROM sigma.lotes_historia WHERE proceso > 0 " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct, CONCAT((SELECT pct), '%') AS pctchar  FROM sigma.cat_procesos a " + cadWhereExt + ") ORDER BY 1, 2, 8 DESC, 4 ASC";
      this.sentenciaR = "SELECT 'Tiempo ocupado por operacion', '', '', '', '', '', '' UNION SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "dd-MMM-yyyy HH:mm:ss") + "', '', '', '', '', '', '' UNION SELECT 'Rango: " + this.periodo + "', '', '', '', '', '', '' UNION SELECT 'Operacion', 'Total lotes', 'Lotes OK', 'Lotes con demora', 'Total estimado', 'Total utilizado', 'Tiempo ocupado (%)' UNION SELECT a.nombre, IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso = a.id  " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IFNULL((SELECT SUM(c.tiempo_estimado - b.tiempo_stock) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso = a.id " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo_proceso) FROM sigma.lotes_historia WHERE proceso = a.id " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct FROM sigma.cat_procesos a " + cadHaving + " UNION SELECT 'TOTAL GENERAL', IFNULL((SELECT COUNT(*) FROM sigma.lotes_historia WHERE proceso > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF((c.tiempo_estimado - b.tiempo_stock) >= c.tiempo_proceso, 1, 0)) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso > 0 " + cadWhere + "), 0) AS buenos, (SELECT total) - (SELECT buenos) AS malos, IFNULL((SELECT SUM(c.tiempo_estimado - b.tiempo_stock) FROM sigma.lotes_historia c INNER JOIN sigma.det_rutas b ON c.ruta_detalle = b.id WHERE c.proceso > 0 " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo_proceso) FROM sigma.lotes_historia WHERE proceso > 0 " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct FROM sigma.cat_procesos a ";      
    }
    if (vista == 3)
    {
      this.tituloReporte ="Tiempo ocupado por Numero de parte " + this.periodo
      sentencia = "SELECT * FROM (SELECT 1 as pos, a.nombre, IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE estado = 99 AND parte = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE estado = 99 AND parte = a.id " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE estado = 99 AND parte = a.id " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE estado = 99 AND parte = a.id " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE estado = 99 AND parte = a.id " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct, CONCAT((SELECT pct), '%') AS pctchar FROM sigma.cat_partes a " + cadHaving + ") as query01 UNION (SELECT 0, 'TOTAL GENERAL', IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE estado = 99 AND parte > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE estado = 99 AND parte > 0 " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE estado = 99 AND parte > 0 " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE estado = 99 AND parte > 0 " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE estado = 99 AND parte > 0 " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ROUND(((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 1), 0) AS pct, CONCAT((SELECT pct), '%') AS pctchar FROM sigma.cat_partes a) ORDER BY 1, 8 DESC, 4 DESC, 2 ASC";
      this.sentenciaR = "SELECT 'Tiempo ocupado por numero de parte', '', '', '', '', '', '', '' UNION SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "dd-MMM-yyyy HH:mm:ss") + "', '', '', '', '', '', '', '' UNION SELECT 'Rango: " + this.periodo + "', '', '', '', '', '', '', '' UNION SELECT 'Numero de parte', 'Referencia', 'Total lotes', 'Lotes OK', 'Lotes con demora', 'Total estimado', 'Total utilizado', 'Desviación (%)' UNION SELECT a.nombre, a.referencia, IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 0) AS pct FROM sigma.cat_partes a " + cadHaving + " UNION SELECT 'TOTAL GENERAL', '', IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, 100 + ((SELECT treal) - (SELECT estimado)) / (SELECT estimado) * 100, 0) AS pct FROM sigma.cat_partes a ";            
    }
    if (vista == 4)
    {
      ...
      //this.sentenciaR = "SELECT 'Variación del tiempo estándar por numero de parte', '', '', '', '', '', '', '' UNION (SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "dd-MMM-yyyy HH:mm:ss") + "', '', '', '', '', '', '', '') UNION (SELECT 'Rango: " + this.periodo + "', '', '', '', '', '', '', '') UNION (SELECT 'Numero de parte', 'Referencia', 'Total lotes', 'Lotes OK', 'Lotes con demora', 'Total estimado', 'Total utilizado', 'Desviación (%)') UNION (SELECT a.nombre, a.referencia, IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE parte = a.id " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, ((SELECT estimado) - (SELECT treal)) / (SELECT estimado) * 100, 0) AS pct FROM sigma.cat_partes a " + cadHaving + ") UNION (SELECT 'TOTAL GENERAL', '', IFNULL((SELECT COUNT(*) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS total, IFNULL((SELECT SUM(IF(tiempo_estimado >= tiempo, 1, 0)) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS buenos, IFNULL((SELECT SUM(IF(tiempo_estimado < tiempo, 1, 0)) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS malos, IFNULL((SELECT SUM(tiempo_estimado) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS estimado, IFNULL((SELECT SUM(tiempo) FROM sigma.lotes WHERE parte > 0 " + cadWhere + "), 0) AS treal, IF((SELECT estimado) > 0, ((SELECT estimado) - (SELECT treal)) / (SELECT estimado) * 100, 0) AS pct FROM sigma.cat_partes a);";            
    }
    if (vista == 5)
    {
    ...
    if (vista == 6)
    {
      ...
      this.sentenciaR = "SELECT 'Reporte de cumplimiento por operacion (grafica)', '', '', '', '' UNION SELECT 'Fecha del reporte: 13-sept.-2019 18:48:15', '', '', '', '' UNION SELECT 'Proceso', 'Referencia', 'Lotes totales', 'Lotes OK', 'Lotes con demora' UNION SELECT c.nombre AS pref, c.referencia, COUNT(*) AS total, SUM(IF((a.tiempo_estimado - b.tiempo_stock) >= a.tiempo_proceso, 1, 0)) AS buenos, SUM(IF((a.tiempo_estimado - b.tiempo_stock) < a.tiempo_proceso, 1, 0))  AS malos FROM sigma.lotes_historia a INNER JOIN sigma.det_rutas b ON a.ruta_detalle = b.id LEFT JOIN sigma.cat_procesos c ON a.proceso = c.id  " + cadWhere + "GROUP BY 1 ";      
    
    }
    if (vista == 7)
    {
      this.tituloReporte ="Productividad por operación " + this.periodo
      sentencia = "SELECT * FROM (SELECT b.nombre AS liga, COUNT(*) AS total, 0 as buenos, SUM(a.tiempo_estimado - c.tiempo_stock), SUM(a.tiempo_proceso), ROUND(IF(SUM(a.tiempo_estimado - c.tiempo_stock) = 0,  0, 100 + (SUM(a.tiempo_proceso) - SUM(a.tiempo_estimado - c.tiempo_stock)) / SUM(a.tiempo_estimado - c.tiempo_stock) * 100), 0) AS malos FROM sigma.lotes_historia a LEFT JOIN sigma.cat_procesos b ON a.proceso = b.id INNER JOIN sigma.det_rutas c ON a.ruta_detalle = c.id " + cadWhere + "GROUP BY 1) AS query01 ORDER BY 1;";
      this.sentenciaR = "SELECT 'Reporte de cumplimiento por operacion (grafica)', '', '', '', '', '', UNION SELECT 'Fecha del reporte: 13-sept.-2019 18:48:15', '', '', '', '', '' UNION SELECT 'Proceso', 'Referencia', 'Lotes totales', 'Lotes OK', 'Lotes con demora', 'Uso del tiempo (%)' UNION SELECT b.nombre AS pref, b.referencia, COUNT(*) AS total, SUM(IF((a.tiempo_estimado - c.tiempo_stock) >= a.tiempo_proceso, 1, 0)) AS buenos, SUM(IF((a.tiempo_estimado - c.tiempo_stock) < a.tiempo_proceso, 1, 0)) AS malos, ROUND(IF(SUM(a.tiempo_estimado - c.tiempo_stock) = 0,  0, 100 + (SUM(a.tiempo_proceso) - SUM(a.tiempo_estimado - c.tiempo_stock)) / SUM(a.tiempo_estimado - c.tiempo_stock) * 100), 0) FROM sigma.lotes_historia a LEFT JOIN sigma.cat_procesos b ON a.proceso = b.id INNER JOIN sigma.det_rutas c ON a.ruta_detalle = c.id " + cadWhere + "GROUP BY 1 ";      
...
buscarConsulta()
    ...
    if (id == 1)
    {
      ...
      else
      {
        ...
        this.servicio.consultasBD(campos).subscribe( resp =>
        {
          ...
          {
            let sentencia = "SELECT 'Reporte de lotes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "yyyy/MM/dd HH:mm:ss") + "', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'Desde: " + this.servicio.fecha(2, this.detalleRegistro.desde, "dd-MMM-yyyy") + " Hasta: " + this.servicio.fecha(2, this.detalleRegistro.hasta, "dd-MMM-yyyy") + "', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'id', 'Numero del lote', 'Fecha de entrada', 'Fecha de estimada de salida', 'Fecha real de salida', 'Tiempo total estimado (segundos)', 'Tiempo total ocupado (segundos)', 'Diferencia (estimado - real)', 'Estatus del registro', 'Referencia del nro de parte', 'Descripcion del nro de parte', 'Prioridad', 'Carga pre-asignada', 'Estado', 'Nombre del proceso actual', 'Nombre del equipo actual', 'Nombre de la operación', 'Secuencia', 'Total inspecciones', 'Fecha de la últimma inspeccion', 'Causa de la últimma inspeccion', 'Usuario que efectuo la últimma inspeccion', 'Total rechazos', 'Fecha del últimmo rechazo', 'Causa del últimmo rechazo', 'Usuario que efectuó el ultimo rechazo', 'Total de alarmas', 'Tiempo de stock excedido', 'Tiempo de proceso excedido' UNION ALL SELECT a.id, a.numero, a.inicia, a.estimada, a.finaliza, a.tiempo, a.tiempo_estimado, (a.tiempo_estimado - a.tiempo), IF(a.estatus = 'A', 'activo', 'inactivo') AS estatus, IFNULL(d.referencia, 'N/A') AS referencia, IFNULL(d.nombre, 'N/A') AS producto, IFNULL((SELECT MIN(orden) FROM sigma.prioridades WHERE parte = a.parte AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), 'N/A') AS prioridad, j.carga  , CASE WHEN a.estado = 0 THEN 'En Espera' WHEN a.estado = 20 THEN 'En Stock' WHEN a.estado = 50 THEN 'En Proceso' WHEN a.estado = 80 THEN 'En Inspección' WHEN a.estado = 90 THEN 'Rechazado' WHEN a.estado = 99 THEN 'Finalizado' END as estado, IFNULL(e.nombre, 'N/A') AS nproceso, IFNULL(b.nombre, 'N/A') AS nequipo, IFNULL(c.nombre, 'N/A') AS nruta_detalle, ruta_secuencia, a.inspecciones, a.inspeccion, IFNULL(f.nombre, 'N/A') AS insp_causa, IFNULL(h.nombre, 'N/A') AS insp_por, a.rechazos, a.rechazo, IFNULL(g.nombre, 'N/A') AS recha_causa, IFNULL(i.nombre, 'N/A') AS recha_por, a.alarmas, IF(a.alarma_tse = 'S', 'Si', 'No'), IF(a.alarma_tpe = 'S', 'Si', 'No') FROM sigma.lotes a LEFT JOIN sigma.det_procesos b ON a.equipo = b.id LEFT JOIN sigma.det_rutas c ON a.ruta_detalle = c.id LEFT JOIN sigma.cat_partes d ON a.parte = d.id LEFT JOIN sigma.cat_procesos e ON a.proceso = e.id LEFT JOIN sigma.cat_situaciones f ON a.inspeccion_id = f.id LEFT JOIN sigma.cat_situaciones g ON a.rechazo_id = g.id LEFT JOIN sigma.cat_usuarios h ON a.inspeccionado_por = h.id LEFT JOIN sigma.cat_usuarios i ON a.rechazado_por = i.id LEFT JOIN sigma.cargas j ON a.carga = j.id " + filtro + " "; 
            if (this.detalleRegistro.reporte==1)
            {
              sentencia = "SELECT 'Reporte de alertas', '', '', '', '', '', '', '', '' UNION SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "yyyy/MM/dd HH:mm:ss") + "', '', '', '', '', '', '', '', '' UNION SELECT 'Desde: " + this.servicio.fecha(2, this.detalleRegistro.desde, "dd-MMM-yyyy") + " Hasta: " + this.servicio.fecha(2, this.detalleRegistro.hasta, "dd-MMM-yyyy") + "', '', '', '', '', '', '', '', '' UNION SELECT 'ID de la alerta', 'Tipo de alerta', 'Lote/Carga', 'Descripcion (Numero de parte)', 'Referencia (número de parte)', 'Operación', 'Inicio de la alerta', 'Fin de la alerta', 'Tiempo alertado' UNION SELECT a.id, CASE WHEN a.tipo = 1 THEN 'Tiempo de stock excedido' WHEN a.tipo = 2 THEN 'Tiempo de proceso excedido' WHEN a.tipo = 3 THEN 'Tiempo de programación excedido' WHEN a.tipo = 4 THEN 'Salto de operación' WHEN a.tipo = 5 THEN 'Antipación de tiempo de stock' WHEN a.tipo = 6 THEN 'Antipación de tiempo de proceso' WHEN a.tipo = 7 THEN 'Anticipacion de tiempo de programación' END AS tipo, b.numero, IFNULL(d.nombre, 'N/A') AS producto, IFNULL(d.referencia, 'N/A') AS referencia, IFNULL(e.nombre, 'N/A') AS nproceso, a.inicio, a.fin, a.tiempo FROM sigma.alarmas a LEFT JOIN sigma.lotes b ON a.lote = b.id " + filtroD + " LEFT JOIN sigma.cat_partes d ON b.parte = d.id LEFT JOIN sigma.cat_procesos e ON a.proceso = e.id WHERE (a.tipo <> 3 AND a.tipo <> 7) " + filtro + " UNION SELECT a.id, CASE WHEN a.tipo = 1 THEN 'Tiempo de stock excedido' WHEN a.tipo = 2 THEN 'Tiempo de proceso excedido' WHEN a.tipo = 3 THEN 'Tiempo de programación excedido' WHEN a.tipo = 4 THEN 'Salto de operación' WHEN a.tipo = 5 THEN 'Antipación de tiempo de stock' WHEN a.tipo = 6 THEN 'Antipación de tiempo de proceso' WHEN a.tipo = 7 THEN 'Anticipacion de tiempo de programación' END AS tipo, b.carga, '', '', IFNULL(e.nombre, 'N/A') AS nproceso, a.inicio, a.fin, a.tiempo FROM sigma.alarmas a LEFT JOIN sigma.cargas b ON a.lote = b.id " + filtroD + " LEFT JOIN sigma.cat_procesos e ON a.proceso = e.id WHERE (a.tipo = 3 OR a.tipo = 7) " + filtro + " ";
            }
            else if (this.detalleRegistro.reporte==2)
            {
              sentencia = "SELECT 'Reporte de calidad', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'Fecha del reporte: " + this.servicio.fecha(1, "", "yyyy/MM/dd HH:mm:ss") + "', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'Desde: " + this.servicio.fecha(2, this.detalleRegistro.desde, "dd-MMM-yyyy") + " Hasta: " + this.servicio.fecha(2, this.detalleRegistro.hasta, "dd-MMM-yyyy") + "', '', '', '', '', '', '', '', '', '', '' UNION ALL SELECT 'Lote', 'Descripcion (Numero de parte)', 'Referencia (número de parte)', 'Situación', 'Tipo', 'Usuario', 'Operación', 'Secuencia de la ruta', 'Inicio de la revisión', 'Fin de la revisión', 'Tiempo en revisión' UNION ALL SELECT b.numero, IFNULL(d.nombre, 'N/A') AS producto, IFNULL(d.referencia, 'N/A') AS referencia, IFNULL(f.nombre, 'N/A') AS insp_causa, IF(a.tipo = 0, 'CALIDAD', 'SCRAP/RECHAZO/MERMA'), IFNULL(h.nombre, 'N/A') AS insp_por, IFNULL(e.nombre, 'N/A') AS nproceso, a.secuencia, a.inicia, a.finaliza, a.tiempo FROM sigma.calidad_historia a LEFT JOIN sigma.lotes b ON a.lote = b.id LEFT JOIN sigma.cat_partes d ON a.parte = d.id LEFT JOIN sigma.cat_procesos e ON a.proceso = e.id LEFT JOIN sigma.cat_situaciones f ON a.inspeccion_id = f.id LEFT JOIN sigma.cat_usuarios h ON a.inspeccionado_por = h.id " + filtro + " "; 
            }
            let campos = {accion: 150, sentencia: sentencia, archivo: 'archivo_usuario_' + this.servicio.rUsuario().id};  
            this.servicio.consultasBD(campos).subscribe( resp =>
            {
              this.http.get(this.URL_FOLDER + 'archivo_usuario_' + this.servicio.rUsuario().id + '.csv', {responseType: 'arraybuffer'})
              .subscribe((res) => {
                  this.writeContents(res, archivo, 'text/csv'); 
              });
            })
  ...
  exportar()
  {
    ...
    let campos = {accion: 150, sentencia: this.sentenciaR, archivo: 'archivo_grafica_' + this.servicio.rUsuario().id};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
      this.http.get(this.URL_FOLDER + 'archivo_grafica_' + this.servicio.rUsuario().id + '.csv', {responseType: 'arraybuffer'})
      .subscribe((res) => {
          this.writeContents(res, nombreReporte, 'text/csv'); 
      });
    })
  }
  ...
  cadaSegundo()
  {
      ...
      let sentencia = "SELECT a.*, CASE WHEN a.tipo = 1 THEN 'Tiempo de stock excedido' WHEN a.tipo = 2 THEN 'Tiempo de proceso excedido' WHEN a.tipo = 3 THEN 'Tiempo de programación excedido' WHEN a.tipo = 4 THEN 'Salto de operación' WHEN a.tipo = 5 THEN 'Antipación de tiempo de stock' WHEN a.tipo = 6 THEN 'Antipación de tiempo de proceso' WHEN a.tipo = 7 THEN 'Anticipacion de tiempo de programación' END AS nombre_alerta, b.numero, c.nombre, c.referEncia FROM sigma.alarmas a LEFT JOIN sigma.lotes b ON a.lote = b.id  LEFT JOIN sigma.cat_partes c ON b.parte = c.id WHERE ISNULL(a.fin) AND tipo <> 4 ORDER BY a.inicio";
      let campos = {accion: 100, sentencia: sentencia};  
      this.servicio.consultasBD(campos).subscribe( resp =>
      {
